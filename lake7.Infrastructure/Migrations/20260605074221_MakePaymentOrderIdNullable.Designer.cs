...
namespace lake7.Infrastructure.Migrations
{
    ...
    [Migration("20260605074221_MakePaymentOrderIdNullable")]
    partial class MakePaymentOrderIdNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("lake7.Domain.Entities.AdminAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastLogin = new DateTime(2024, 5, 8, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Password = "admin123",
                            Role = "SuperAdmin",
            ...
            modelBuilder.Entity("lake7.Domain.Entities.MenuItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("lake7.Domain.Entities.Restaurant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("lake7.Domain.Entities.MenuItem", b =>
                {
                    b.HasOne("lake7.Domain.Entities.Restaurant", "Restaurant")
                        .WithMany("MenuItems")
